...
\begin{indentsection}
	...
	\skill{Advanced}{JavaScript, Python, Shell Scripting, ReactJS, Spring Batch, Hibernate, MyBatis, Gradle, MySQL, MariaDb, AWS EC2, ECS \& ELB, Jira, Confluence, RabbitMQ, Apache Kafka, Pandas}
